...
public class RogiTester {
	...
	public static void main(String[] args) {
		RogiDTO dto1 = new RogiDTO(1, "ram", 20, "fever", true);
		RogiDTO dto2 = new RogiDTO(2, "rohan", 23, "cold", true);
		RogiDTO dto3 = new RogiDTO(3, "roshan", 22, "cancer", false);
		RogiDTO dto4 = new RogiDTO(4, "rohini", 21, "corona", true);
		RogiDTO dto5 = new RogiDTO(5, "rohit", 24, "small pox", true);
